...
# #reverse the string 
# #print(result[::-1])
# #get a subtring from a string
# #index slicing is when you get a substring from a string 
# #the start index is inclusive, the end index is exclusive 
# #get the last letter of string 
# print(result[-1])
# print(result.find('string'))
# print(result[15:-1])


#-1 means the substring is not found or dosen't excist 
...
print(substring)
subtring = text [2:5]
#get the first letter all the way to the 4th letter all the way to the end of the string
print(text[0:])
